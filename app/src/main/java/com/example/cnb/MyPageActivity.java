...
public class MyPageActivity extends AppCompatActivity {
    ...
    public void sendRequest(){
        String url = "http://cnb.dothome.co.kr/FavoriteCompanyList.php";

        StringRequest request = new StringRequest(
                Request.Method.POST,
                url,
                new Response.Listener<String>() {  // 응답을 성공적으로 받았을 때 자동 호출
                    @Override
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                map=new HashMap<>();
                map.put("id",getIntent().getExtras().getString("userId"));
                return map;
            }
        };
    ...
    public void deleteList(final String name){
        String url = "http://cnb.dothome.co.kr/FavoriteCompanyDelete.php";
